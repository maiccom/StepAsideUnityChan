...
public class ItemGenerator : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        lastcreate = this.unitychan.transform.position.z;
    ...
    void Update()
    {
        //Unitychan - lastcreate
        float distance = this.unitychan.transform.position.z - lastcreate;


        //lastcreateとUnitychanのZ座標を比較
        if (distance > 15)
        {
            lastcreate = this.unitychan.transform.position.z;
